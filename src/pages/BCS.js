...
export default function BCS() {
    ...
    return(
        <main>
            <h1 style={{paddingTop:"20px",textAlign:"center"}}>BETTER CALL SAUL CHARACTERS</h1>
            <div style={{paddingTop:"20px",paddingBottom:"50px",paddingRight:"30px",display:"flex",flexWrap:"wrap",align:"center"}}>
                {data.map((data,index) => {
                    return(
                        <Link to={{pathname:"/detailBCS"}} onClick={() => {getCharId = data.char_id}} style={{textDecoration:"none"}}>
                            <div className="card">
                                <figure>
